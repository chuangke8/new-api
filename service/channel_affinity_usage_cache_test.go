...
func uniqueChannelAffinityUsageCacheTestID(t *testing.T) string {
	t.Helper()
	return fmt.Sprintf("%s_%d", t.Name(), channelAffinityUsageCacheTestSeq.Add(1))
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := "rule_" + uniqueChannelAffinityUsageCacheTestID(t)
	usingGroup := "default"
	keyFP := "fp_" + uniqueChannelAffinityUsageCacheTestID(t)
