...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/xunhupay/notify", anonymousRequestBodyLimit, controller.XunhuPayNotify)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/contact-assets", controller.UploadContactAsset)
		...
		apiRouter.GET("/contact-assets/*path", controller.GetContactAsset)
