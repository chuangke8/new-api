...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"contact": gin.H{
			"wechat_qr_image":  common.OptionMap["contact.wechat_qr_image"],
			"support_qr_image": common.OptionMap["contact.support_qr_image"],
			"wechat_id":        common.OptionMap["contact.wechat_id"],
			"email":            common.OptionMap["contact.email"],
		},
